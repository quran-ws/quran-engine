...
| iOS (Swift) | `packages/ios` — `QvpKit` Swift package (binary XCFramework over `qvp.h`, CoreGraphics `QvpPageView`) and a SwiftUI reader demo. Build with `scripts/build-engine-ios.sh` |
