...
| optional web data | `web/data.mjs`, `web/data-hafs.mjs`, `web/metadata.mjs` | verified fetching, release descriptor and canonical metadata; no bundled corpus or artwork; see `docs/WEB-DATA.md` |
