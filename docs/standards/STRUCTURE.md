...
| thing | home | rule |
|---|---|---|
| engine logic | `crates/qvp-core` | the only place that makes a decision |
...
| a platform demo | `packages/<platform>/example/` (Flutter: inside the package, as pub expects) | page data gitignored and provisioned by `scripts/sync-example-data.sh`. Every demo implements `docs/EXAMPLE-APP.md` |
