...
| optional web data | `web/data.mjs`, `web/data-hafs.json`, `web/metadata.mjs`, `web/surahs.json` | verified fetching, release descriptor and canonical metadata; no bundled corpus or artwork; see `docs/WEB-DATA.md` |
