...
```
https://cdn.quran.ws/qvp/v0.1.0/manifest.json
https://cdn.quran.ws/qvp/v0.1.0/001.qvp
https://cdn.quran.ws/qvp/v0.1.0/001.words.json
https://cdn.quran.ws/qvp/v0.1.0/atlas.qva
https://cdn.quran.ws/qvp/v0.1.0/hafs-kfgqpc.tar.br
```
...
```json
{ "version": "v0.1.0",
  "manifest": "https://cdn.quran.ws/qvp/v0.1.0/manifest.json",
